...
// TODO: rework
@Component
public class NFATransformationAdapter extends AbstractTransformationAdapter
    implements NFATransformationPort {
  ...
  private TreeSet<Integer> resolveAcceptStates(
      NFAEntity entity, ArrayList<TreeSet<Integer>> nfaToDfaStateTransitions) {
