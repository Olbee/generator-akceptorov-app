...
public class DotGraphTransformationAdapter implements DotGraphTransformationPort {
    ...
    public byte[] convertToPNG(String dot) {
        ...
        // Ability to generate very large graphs (it takes a long time and the default timeout is 10 seconds)
        try (GraphvizCmdLineEngine engine = new GraphvizCmdLineEngine().timeout(100000, TimeUnit.SECONDS)) {
